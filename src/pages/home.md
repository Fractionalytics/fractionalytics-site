...
**Part B. Fix the things worth fixing.** I own detection, matching, triage and measurement. Your team owns the source-system changes and the business calls about what a number should mean, because those are not mine to make. Weeks rather than months, and the measurement is agreed before the work starts so that "done" is not a matter of opinion. Either a block of hours or a formal statement of work, whichever suits how you buy.
...
I set AI strategy with leadership teams, build the data and systems underneath it, and ship the highest-leverage pieces myself. Decades in data across venture, private-equity-backed operating companies and payments, in the US and Latin America.
